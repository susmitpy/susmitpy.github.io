...
export const TalksCarousel = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-obsidian-900 rounded-xl" id="talks">
      <div className="flex items-center justify-between mb-3 px-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-7 h-7 rounded-full bg-white/5 border border-white/10 items-center justify-center hover:bg-indigo-500/10 hover:border-indigo-500/30 transition-all hidden md:flex"
      ...
      <div className="hidden md:flex flex-1 overflow-x-auto pb-2 hide-scrollbar gap-3 px-1">
      ...
      {/* Mobile view - all talks in continuous flow */}
      <div className="md:hidden flex-1 overflow-x-auto pb-2 hide-scrollbar flex gap-3 px-1">
